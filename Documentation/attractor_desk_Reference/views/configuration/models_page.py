...
class ModelsPage(QWidget):
    ...
    def _setup_ui(self) -> None:
        ...
        api_section.setStyleSheet("font-size: 14px; font-weight: bold; color: #89b4fa;")
        ...
        model_section.setStyleSheet("font-size: 14px; font-weight: bold; color: #89b4fa; margin-top: 10px;")
        ...
        add_model_section.setStyleSheet("font-size: 14px; font-weight: bold; color: #89b4fa; margin-top: 10px;")
    ...
    def _refresh_default_combo(self) -> None:
        """Refresh the default model combo."""
