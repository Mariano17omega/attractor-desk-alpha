...
[X] 2) Dead graph nodes: `generateFollowup` and `reflect`
...
[X] 3) RAG query extraction breaks on multi-part message content
...
[X] 4) Stale worker results can be applied to a new session or after cancellation
...
[X] 5) Highlighted text update may edit the wrong occurrence
